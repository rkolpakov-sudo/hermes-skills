...
**Note:** Gmail requires an App Password if 2FA is enabled. Google App Passwords are **always exactly 16 characters** (displayed as 4 groups of 4, e.g. `abcd efgh ijkl mnop` — use them without spaces). If the password you generated is shorter than 16 chars, it was not copied completely or was truncated. Regenerate at https://myaccount.google.com/apppasswords and copy the full string.

If App Password generation page says "App passwords are not available", two-factor authentication is **not enabled** on this account — enable it first at https://myaccount.google.com/signinoptions/two-step-verification before creating an app password.
